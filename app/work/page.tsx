...
export const metadata: Metadata = {
  ...
  description:
    'Case studies from Clearforge Labs — real builds for small businesses and online communities: websites, payment flows, booking, and automation.',
  alternates: {
    canonical: '/work',
  },
  openGraph: {
    title: 'Work & Case Studies | Clearforge Labs',
    description: 'Real projects: websites that convert, payments, booking systems, and automation.',
        ...
        <section className="section-padding bg-neutral-50">
          <div className="container-custom">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-neutral-600">Every project is built with speed, clarity, and conversion in mind.</p>
            </div>
          </div>
        </section>
        ...
        <section id="urmi-threading" className="section-padding bg-white">
          <div className="container-custom">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-12 mb-12">
                <div>
                  ...
                  <p className="text-neutral-700 mb-6">
                    Urmi Threading Salon had an outdated website that wasn&apos;t mobile-friendly. Potential clients
                    couldn&apos;t easily find services, pricing, or contact information. They were losing business to
              ...
              {/* Screenshot */}
              <div className="border-2 border-neutral-300 overflow-hidden">
                <img
                  src="/work/urmi.png"
                  alt="Urmi Threading Salon website screenshot"
              ...
              {/* NOTE:
                  ...
                  /public/work/urmi.png
              */}
            </div>
          </div>
        </section>

        {/* Case Study 2: WSD Referral System */}
            ...
            <div className="max-w-4xl mx-auto">
              <div className="mb-8">
                ...
                <p className="text-xl text-neutral-600">
                  Website + automated referral tracking for a paid trading community (Whop integration)
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-12 mb-12">
                <div>
                  ...
                  <p className="text-neutral-700 mb-6">
                    ...
                    that worked with their existing stack (including Whop).
                  </p>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 mt-1 flex-shrink-0" />
                      <span>Community website (funnels + onboarding)</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 mt-1 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 mt-1 flex-shrink-0" />
                      <span>Whop integration for membership + attribution</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 mt-1 flex-shrink-0" />
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    ...
                    <span className="px-4 py-2 bg-charcoal-900 text-white text-sm font-medium">Whop</span>
                    <span className="px-4 py-2 bg-charcoal-900 text-white text-sm font-medium">MongoDB</span>
                  </div>

                  <h3 className="text-xl font-bold mb-4">Outcome</h3>
                  <p className="text-neutral-700 mb-4">
                    The community saved 10+ hours per week on manual tracking. Referrals became automated end-to-end, member
                    disputes dropped, and referral participation increased.
                  </p>
                  <div className="bg-white p-6 border-l-4 border-charcoal-900">
                    <p className="font-semibold mb-2">Delivered in 9 days</p>
                    <p className="text-neutral-600">Including testing, integration setup, and admin training.</p>
                  </div>
                </div>
              </div>

              {/* Screenshot (Bot/Whop integration view) */}
              <div className="border-2 border-neutral-300 overflow-hidden">
                <img
                  src="/work/wsd.png"
                  alt="WSD referral bot dashboard screenshot (Whop integration)"
                  className="w-full h-auto object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-12">
                <div>
                  ...
                  <p className="text-neutral-700 mb-6">
                    Multiple clients needed custom payment implementations: one-time deposits, subscription billing, and
                    invoice systems. Each required different flows but all needed to be simple for customers and easy for
                    owners to manage.
                  </p>
